const TILE_BANK = 'w-full h-(--tile-h) rounded-xl bg-white border-2 border-charcoal shadow-[0_4px_0_#1a1a1a] flex items-center justify-center text-[length:var(--tile-fs)] font-bold text-charcoal cursor-pointer select-none transition-[transform,box-shadow] duration-100 active:translate-y-1 active:shadow-[0_0_0_#1a1a1a] px-1 font-slab';
